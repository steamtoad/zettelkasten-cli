...
"$repo/tests/zt-standardize-cli-preflight-and-selection.zsh"
"$repo/tests/zt-add-recoverable-workflow-transactions.zsh"
"$repo/tests/zt-clarify-topic-membership-contract.zsh"
"$repo/tests/zt-complete-notes-directory-migration.zsh"
