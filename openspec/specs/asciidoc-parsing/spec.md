# asciidoc-parsing Specification

## Purpose

Определить единые правила разбора AsciiDoc header, opaque-блоков и управляемых ссылок для всех runtime-потребителей.
...
- **THEN** получена ошибка до изменения всех затронутых файлов
...
- **THEN** байты файла не изменяются, дубликат отсутствует
...
- **GIVEN** имеются fixtures пяти прежних constructor interfaces
