# document-integrity Specification
...
- **THEN** отказ происходит до создания документа; существующие документы неизменны
...
- **THEN** получен ненулевой exit; нового файла и journal entry нет
...
- **THEN** получен `ERROR TOPIC_METADATA`; checker не исправляет её автоматически
